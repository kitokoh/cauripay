...
describe('MerchantsService', () => {
  ...
  it('génère un payment-request avec QR SVG + URL', () => {
    const p = service.createPaymentRequest('m1', { amountMinor: 25000, currency: 'XAF', reference: 'cmd-42' });
  ...
  it('refuse un montant non positif', () => {
    expect(() => service.createPaymentRequest('m1', { amountMinor: 0, currency: 'XAF', reference: 'r' })).toThrow();
  });
